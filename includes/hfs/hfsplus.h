...
extern "C" {
	...
	/* If `rec` points to a catalog record with recordtype equal to either
	   kHFSPlusFileThreadRecord or kHFSPlusFolderThreadRecord, return `rec`
		 (cast to HFSPlusCatalogThread*). Otherwise, return NULL. */
	HFSPlusCatalogThread* tryCatalogRecordAsThread(HFSPlusCatalogRecord* rec);
	/* If `rec` points to a catalog record with recordtype
	   kHFSPlusFileThreadRecord, return `rec` (cast as HFSPlusCatalogThread*).
		 Otherwise, return NULL. */
	HFSPlusCatalogThread* tryCatalogRecordAsFileThread(HFSPlusCatalogRecord *rec);
	/* If `rec` points to a catalog record with recordtype
	   kHFSPlusFolderThreadRecord, return `rec` (cast as HFSPlusCatalogThread*).
		 Otherwise, return NULL. */
